...
import { initialRootState } from "../reducers/rootReducer";
...
describe("<App/> tests", () => {
  ...
  it("Checks if 'isLoggedIn === true' the hide <Login /> and show <CourseList />", () => {
    ...
    wrapper = shallow(<App isLoggedIn={loggedInUser.isLoggedIn} />);
